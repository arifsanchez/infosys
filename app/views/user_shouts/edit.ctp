...
<?php echo $this->Form->create('UserShout');?>
	<fieldset>
		<legend><?php __('Edit User Shout'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('UserShout.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('UserShout.id'))); ?></li>
