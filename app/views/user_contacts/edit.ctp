...
<?php echo $this->Form->create('UserContact');?>
	<fieldset>
		<legend><?php __('Edit User Contact'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('UserContact.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('UserContact.id'))); ?></li>
